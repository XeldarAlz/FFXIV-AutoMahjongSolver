...
public sealed class AboutWindow : Window, IDisposable
{
    ...
    public AboutWindow() : base("Doman Mahjong Solver — About###domanmahjong-about")
    {
    ...
    private static void OpenInBrowser(string url)
    {
        ...
        {
            Plugin.Log.Warning(ex, "[DomanMahjongAI] failed to launch browser for {0}, copied to clipboard instead", url);
