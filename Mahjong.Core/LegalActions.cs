...
/// an opponent's discard (or announce a self-kan). Populated by the addon reader
...
/// <summary>
/// The set of game actions legally available to the current player on this turn.
/// Defensive-copies every list at construction so callers can't mutate the
/// snapshot once it's been built.
/// </summary>
