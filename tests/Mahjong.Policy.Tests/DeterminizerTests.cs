...
public class DeterminizerTests
{
    ...
    public void Sample_returns_three_opponent_hands_of_13()
    {
        ...
        m.Update(s);
        var d = new Determinizer(new SeededRandomSource(42));
    ...
    public void Sample_excludes_tiles_in_our_hand()
    {
        ...
        var m = new OpponentModel();
        m.Update(s);
        var d = new Determinizer(new SeededRandomSource(123));
        var sample = d.Sample(s, m);
        Assert.NotNull(sample);
    ...
    public void Opponent_with_open_meld_gets_smaller_hand()
    {
        ...
        var m = new OpponentModel();
        m.Update(s);
        var d = new Determinizer(new SeededRandomSource(7));
        var sample = d.Sample(s, m);
        Assert.NotNull(sample);
    ...
    public void Multiple_samples_produce_different_determinizations()
    {
        ...
        var m = new OpponentModel();
        m.Update(s);
        var d = new Determinizer(new SeededRandomSource(0));
        var s1 = d.Sample(s, m);
        var s2 = d.Sample(s, m);
        Assert.NotNull(s1);
        Assert.NotNull(s2);
